...
function Form() {
  ...
  return (
    <form onSubmit={handleLogin} className="d-flex flex-column align-items-center col-10 col-sm-7 col-md-6 col-lg-5 col-xl-4 col-xxl-3">

      <div className="form-group col-12 my-3">
        <label htmlFor="exampleInputEmail1" className={styles.sr_only}>Email address</label>
        <input type="email" onChange={(e) => setEmail(e.target.value)} value={email} className={`form-control ${styles.input_outline}`} id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email address" autoFocus required />
      </div>
      <div className="form-group col-12 my-3">
      ...
      <div className={`${checkError ? styles.error : styles.sr_only} m-3`}>
