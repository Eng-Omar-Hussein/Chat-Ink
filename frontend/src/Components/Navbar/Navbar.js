      ...
      <nav className="navbar">
        ...
        <div className="nav-links" id="navLinks">
          ...
          <NavLink to="/notifications" className="nav-link fw-bold link">
            <div className="nav-item">
              <img src={Notifications} alt="Notifications" className="icon" style={notificationRead ? {} : {position: 'relative', animation: notificationRead ? 'none' : 'shake 0.5s linear infinite'}} />
              <span style={notificationRead ? {} : {color : "#6FB1B6"}}>Notifications</span>
              <style>
                {`
                  @keyframes shake {
